...
<Video caption="Create the dev environment, and edit files. Hot-reloading is automatic." src="/public/videos/projects/docker-node-template/docker-node-template-demo"/>
